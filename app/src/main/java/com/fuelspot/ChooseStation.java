...
public class ChooseStation extends AppCompatActivity {
    ...
    private void updateMapObject() {
        ...
        String url = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=" + MainActivity.userlat + "," + MainActivity.userlon + "&radius=3500&type=gas_station&opennow=true&key=AIzaSyAOE5dwDvW_IOVmw-Plp9y5FLD9_1qb4vc";
    ...
    public void fetchPrices(final String placeID) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, getString(R.string.API_FETCH_STATION),
            ...
            protected Map<String, String> getParams() {
                ...
                if (MainActivity.fuelPri == 0) {
                    params.put("orderBy", "gasolinePrice");
                } else if (MainActivity.fuelPri == 1) {
                    params.put("orderBy", "dieselPrice");
                } else if (MainActivity.fuelPri == 2) {
